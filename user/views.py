...
from user.forms import SingUpForm, UserUpdateForm, ProfileUpdateForm
...
def user_password(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, "Your password  is successfully update !")
            return HttpResponseRedirect('/user')
        else:
            messages.error(request, "Pleas correct the error below.<br>"+str(form.errors))
